...
ifeq ($(FLASH_TYPE), spinand)
	...
	@echo setenv bootcmd \' $(kernel$(BOOTCMD)) $(rootfs$(BOOTCMD)) dcache on\; bootm $(KERNELBOOTADDR)\; dcache off\; $(kernel$(BOOTREC)) $(rootfs$(BOOTREC)) dcache on \; bootm $(KERNELBOOTADDR) >> $(SCRIPTDIR)/set_config
endif
	if [ -a ../parser_IPL.sh ] ; \
	then \
