...
#ifndef PNL_TABLE_ADT07016BR50
#define PNL_TABLE_ADT07016BR50
MhalPnlParamConfig_t stPanel_ADT07016BR50_1024x600 =
{
    "ADT07016BR50", // const char *m_pPanelName;                ///<  PanelName
    ...
    ///////////////////////////////////////////////
    // sync related
    28,  //MS_U8 m_ucPanelHSyncWidth;               ///<  VOP_01[7:0], PANEL_HSYNC_WIDTH
    50,  //MS_U8 m_ucPanelHSyncBackPorch;           ///<  PANEL_HSYNC_BACK_PORCH, no register setting, provide value for query only
    ...
    1152,  //MS_U16 m_wPanelHTotal;                   ///<  VOP_0C[11:0], PANEL_HTOTAL
    ...
    639,  //MS_U16 m_wPanelVTotal;                   ///<  VOP_0D[11:0], PANEL_VTOTAL
    ...
    50,  //MS_U8 m_dwPanelDCLK;                     ///<  LPLL_0F[23:0], PANEL_DCLK          ,{0x3100_10[7:0], 0x3100_0F[15:0]}
...
MhalPnlMipiDsiConfig_t stMipiDsiConfig_ADT07016BR50_1024x600 =
{
