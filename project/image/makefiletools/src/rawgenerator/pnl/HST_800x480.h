...
MhalPnlParamConfig_t stPanel_HST =
{
    "HST_800x480", // const char *m_pPanelName;                ///<  PanelName
    ...
    48,  //MS_U8 m_ucPanelHSyncBackPorch;           ///<  PANEL_HSYNC_BACK_PORCH, no register setting, provide value for query only
    ...
    12,  //MS_U8 m_ucPanelVBackPorch;               ///<  define PANEL_VSYNC_BACK_PORCH
    ...
    800,  //MS_U16 m_wPanelWidth;                    ///< PANEL_WIDTH, DE width (VOP_05[11:0] = HEnd = HStart + Width - 1)
    ...
    888,  //MS_U16 m_wPanelHTotal;                   ///<  VOP_0C[11:0], PANEL_HTOTAL
    ...
    500,  //MS_U16 m_wPanelVTotal;                   ///<  VOP_0D[11:0], PANEL_VTOTAL
...
MhalPnlMipiDsiConfig_t stMipiDsiConfig_HST =
{
