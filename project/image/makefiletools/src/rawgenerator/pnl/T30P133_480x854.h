...
MhalPnlParamConfig_t stPanel_T30P133 =
{
    "T30P133_480x854", // const char *m_pPanelName;                ///<  PanelName
    ...
    888,  //MS_U16 m_wPanelVTotal;                   ///<  VOP_0D[11:0], PANEL_VTOTAL
...
MhalPnlMipiDsiConfig_t stMipiDsiConfig_T30P133 =
{
