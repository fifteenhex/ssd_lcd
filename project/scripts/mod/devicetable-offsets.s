...
@ GNU C89 (GCC) version 9.1.0 (arm-linux-gnueabihf)
...
@ -iprefix /tools/toolchain/gcc-sigmastar-9.1.0-2019.11-x86_64_arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/9.1.0/
@ -isysroot /tools/toolchain/gcc-sigmastar-9.1.0-2019.11-x86_64_arm-linux-gnueabihf/bin/../arm-linux-gnueabihf/libc
@ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm -D CC_HAVE_ASM_GOTO
@ -D KBUILD_BASENAME="devicetable_offsets"
@ -D KBUILD_MODNAME="devicetable_offsets"
@ -isystem /tools/toolchain/gcc-sigmastar-9.1.0-2019.11-x86_64_arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/9.1.0/include
@ -include ./include/linux/kconfig.h
@ -MD scripts/mod/.devicetable-offsets.s.d
@ scripts/mod/devicetable-offsets.c -mlittle-endian -mabi=aapcs-linux
@ -mno-thumb-interwork -mfpu=vfp -mthumb -mfloat-abi=soft -mtune=cortex-a9
...
@ -Wattribute-alias=0 -Wno-stringop-truncation
@ -Wno-sizeof-pointer-memaccess -Wno-array-bounds -Wno-packed-not-aligned
@ -Wno-address-of-packed-member -Werror -std=gnu90 -fno-strict-aliasing
...
.LASF15:
	.ascii	"/home/fan.zhang/I6e/kernel\000"
.LASF14:
	.ascii	"scripts/mod/devicetable-offsets.c\000"
.LASF13:
	.ascii	"GNU C89 9.1.0 -mlittle-endian -mabi=aapcs-linux -mn"
	.ascii	"o-thumb-interwork -mfpu=vfp -mthumb -mfloat-abi=sof"
	.ascii	"t -mtune=cortex-a9 -mtls-dialect=gnu -march=armv7-a"
	.ascii	" -g -Os -std=gnu90 -fno-strict-aliasing -fno-common"
	.ascii	" -fno-PIE -fno-dwarf2-cfi-asm -fno-ipa-sra -funwind"
	.ascii	"-tables -fno-delete-null-pointer-checks -fstack-pro"
	.ascii	"tector -fomit-frame-pointer -fno-var-tracking-assig"
	.ascii	"nments -fno-strict-overflow -fstack-check=no -fcons"
	.ascii	"erve-stack --param allow-store-data-races=0\000"
.LASF12:
