...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.8.21 2014-12-05 00:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.8.21 2014-12-05 00:00:00 GMT")
#endif
...
if(setsockopt(soap->master,SOL_SOCKET,SO_REUSEADDR, (char*)&len, sizeof(int)) < 0)
 {
  ...
  soap_closesock(soap);
  soap_set_receiver_error(soap, tcp_error(soap), "setsockopt failed in soap_bind11()", SOAP_TCP_ERROR);
      return SOAP_INVALID_SOCKET;
 }
...
if(setsockopt(soap->master,SOL_SOCKET,SO_REUSEADDR, (char*)&len, sizeof(int)) < 0)
 {
  ...
  DBGLOG(TEST, SOAP_MESSAGE(fdebug, "setsockopt  SO_REUSEADDR ERROR\n"));
  soap_closesock(soap);
  soap_set_receiver_error(soap, tcp_error(soap), "setsockopt failed in soap_bind22()", SOAP_TCP_ERROR);
      return SOAP_INVALID_SOCKET;
 }
