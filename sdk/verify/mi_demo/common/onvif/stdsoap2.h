...
{ short state;			/* 0 = uninitialized, 1 = initialized, 2 = copy of another soap struct */
  ...
  char msgbuf[1024+128];	/* in/out buffer for HTTP/MIME headers >=1024 bytes */
  char tmpbuf[1024+128];	/* in/out buffer for HTTP/MIME headers, simpleType values, element and attribute tag names, and DIME must be >=1024 bytes */
