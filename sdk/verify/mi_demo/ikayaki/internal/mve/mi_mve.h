...
typedef enum _MVE_ADD_MODE_E
{
    MVE_ADD_MODE_ROUNDING                  = 0x00, /*Rounding mode*/
    MVE_ADD_MODE_CLIPPING                    = 0x01, /*Clipping Mode*/
    MVE_ADD_MODE_BUTT                            = 0xFF
}MVE_ADD_MODE_E;
...
typedef enum _MVE_LBP_CMP_MODE_E
{
    ...
    MVE_LBP_CMP_MODE_ABS_MUL                    = 0x02,
    MVE_LBP_CMP_MODE_BUTT                       = 0xFF
} MVE_LBP_CMP_MODE_E;

typedef enum _MVE_LBP_CHANNEL_MODE_E
{
    MVE_LBP_CHANNEL_MODE_U8C1                   = 0x00,
    MVE_LBP_CHANNEL_MODE_U8C2                   = 0x01,
    MVE_LBP_CHANNEL_MODE_BUTT                   = 0xFF
} MVE_LBP_CHANNEL_MODE_E;
...
typedef struct _MVE_LBP_CTRL_S
{
    ...
    MVE_LBP_CHANNEL_MODE_E chlMode;  /*Channel Mode*/
...
MI_MVE_RET MI_MVE_LBP(MVE_HANDLE pMveHandle, MVE_SRC_IMAGE_S *pstSrc_1, MVE_SRC_IMAGE_S *pstSrc_2, MVE_DST_IMAGE_S *pstDst, MVE_LBP_CTRL_S *pstLbpCtrl, bool bInstant);
...
MI_MVE_RET MI_MVE_AlphaBlending(MVE_HANDLE pMveHandle, MVE_SRC_IMAGE_S *pstSrc, MVE_SRC_IMAGE_S *pstAlpha, MVE_DST_IMAGE_S *pstDst, bool bInstant);
#ifdef __cplusplus
}
#endif
