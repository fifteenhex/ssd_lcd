...
static unsigned int unicode32_text[MAXLENGTH];
static unsigned short unicode16_text[MAXLENGTH];
...
/* ---------------------------------------------------------------------------*/
/**
 * @brief gb2312_mbtowc gb2312 to unicode
 *
 * @param conv no use
 * @param pwc dest string
 * @param s src string
 * @param n set 2
 *
 * @returns
 */
/* ---------------------------------------------------------------------------*/
static int gb2312_mbtowc (conv_t conv, ucs4_t *pwc, const unsigned char *s, int n)
{
...
/* ---------------------------------------------------------------------------*/
/**
 * @brief gb2312_wctomb unicode to gb2312
 *
 * @param conv no use
 * @param r dest string
 * @param wc src string
 ...
 */
/* ---------------------------------------------------------------------------*/
static int gb2312_wctomb (conv_t conv, unsigned char *r, ucs4_t wc, int n)
{
  if (n >= 2) {
...
/* ---------------------------------------------------------------------------*/
/**
 * utf8ToUnicodeChar - convert UTF-8 char to unicode char
...
/* ---------------------------------------------------------------------------*/
/**
 * utf8ToUnicode - Convert a utf-8 stirng to a utf-16 string
		...
		int  nSrcLength)
{
	...
	nTemp = 0;
	nTemp1 = 0;
	memset(unicode32_text,0,sizeof(unicode32_text));
	...
	unicode32_text[(nSrcLength)-nTemp] = 0;
	nResult = 0;
	unicode32ToUtf8(unicode32_text,sizeof(unicode32_text),ptDestText,nDestLength);
	return nResult;
}
		...
		int len_utf8)
{
	...
	int cont = utf8ToUnicode((unsigned char*)utf8_str,unicode16_text,sizeof(unicode16_text));
