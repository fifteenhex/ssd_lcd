...
#include "F32_init_table.h"         /* Sensor initial table */

/* Sensor EarlyInit implementation */
SENSOR_EARLYINIY_ENTRY_IMPL_BEGIN(F32)
...
static EarlyInitSensorInfo_t _gF32Info =
{
...
*/
static unsigned int F32EarlyInitShutterAndFps( unsigned int nFpsX1000, unsigned int nShutterUs, I2cCfg_t *pRegs, unsigned int nMaxNumRegs)
{
...
#define vts_30fps  1125//1090                              //for 29.091fps @ MCLK=36MHz
    ...
    _gF32Info.u32ShutterUs = nShutterUs;
    _gF32Info.u32FpsX1000 = nFpsX1000;
...
static unsigned int F32EarlyInitGain( unsigned int u32GainX1024, I2cCfg_t *pRegs, unsigned int nMaxNumRegs)
{
...
#define SENSOR_MAX_GAIN     (15872)                  // max sensor again, a-gain * conversion-gain*d-gain
    ...
    _gF32Info.u32GainX1024 = u32GainX1024;
...
static unsigned int F32EarlyInitGetSensorInfo(EarlyInitSensorInfo_t* pSnrInfo)
{
    if(pSnrInfo)
    {
        ...
        pSnrInfo->u32FpsX1000   = _gF32Info.u32FpsX1000;
        pSnrInfo->u32Width      = _gF32Info.u32Width;
        pSnrInfo->u32Height     = _gF32Info.u32Height;
        pSnrInfo->u32GainX1024  = _gF32Info.u32GainX1024;
        pSnrInfo->u32ShutterUs  = _gF32Info.u32ShutterUs;
        pSnrInfo->u32ShutterShortUs = _gF32Info.u32ShutterShortUs;
        pSnrInfo->u32GainShortX1024 = _gF32Info.u32GainShortX1024;
        pSnrInfo->u8ResId       = _gF32Info.u8ResId;
        pSnrInfo->u8HdrMode     = _gF32Info.u8HdrMode;
...
SENSOR_EARLYINIY_ENTRY_IMPL_END( F32,
                                 Sensor_init_table,
                                 F32EarlyInitShutterAndFps,
                                 F32EarlyInitGain,
                                 F32EarlyInitGetSensorInfo
                                );
