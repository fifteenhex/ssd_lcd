...
SENSOR_DRV_ENTRY_IMPL_BEGIN_EX(RN6752_MIPI);
...
static void RN675xM_Pre_initial(ms_cus_sensor *handle);
...
static I2C_ARRAY Sensor_init_table[] =
{
    ...
    {0x5A, 0x48}, // data for extended register //0x48 1080P25fps ; 0x49 1080P30fps
...
int rn6752_cus_camsensor_init_handle(ms_cus_sensor* handle)
{
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id,"rn6752_MIPI");
...
SENSOR_DRV_ENTRY_3CHAHD_IMPL_END_EX(rn6752,
