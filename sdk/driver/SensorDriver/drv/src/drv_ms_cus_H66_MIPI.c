...
SENSOR_DRV_ENTRY_IMPL_BEGIN_EX(H66);
...
#define Preview_line_period 33333//35556                   //2400*1125*30=81
#define vts_30fps  1000//1266//1150//1090                              //for 29.091fps @ MCLK=36MHz
#define Preview_WIDTH       1280//1920                    //resolution Width when preview
#define Preview_HEIGHT      960//1080                    //resolution Height when preview
...
static int pCus_poweroff(ms_cus_sensor *handle, u32 idx)
{
    // power/reset low
   ISensorIfAPI *sensor_if = handle->sensor_if_api;
//    H66_params *params = (H66_params *)handle->private_data;
...
static int pCus_GetSensorID(ms_cus_sensor *handle, u32 *id)
{
    ...
    *id >>= 8;
    SENSOR_DMSG("[%s]H66 Read sensor id, get 0x%x Success\n", __FUNCTION__, (int)*id);
    //SENSOR_DMSG("[%s]Read sensor id, get 0x%x Success\n", __FUNCTION__, (int)*id);

    return SUCCESS;
}

static int H66_SetPatternMode(ms_cus_sensor *handle,u32 mode)
{
...
static int H66_GetShutterInfo(struct __ms_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
static int cus_camsensor_init_handle(ms_cus_sensor* drv_handle) {
   ms_cus_sensor *handle = drv_handle;
    ...
    handle->private_data = CamOsMemCalloc(1, sizeof(H66_params));
    params = (H66_params *)handle->private_data;
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    strcpy(handle->model_id,"H66_MIPI");
    ...
    handle->video_res_supported.res[0].nOutputHeight= 960;
    SENSOR_DMSG(handle->video_res_supported.res[0].strResDesc, "1280x960@30fps");
    ...
    handle->pCus_sensor_SetPatternMode = H66_SetPatternMode;
    ///////////////////////////////////////////////////////
    // AE
    ///////////////////////////////////////////////////////
    // unit: micro seconds
...
//    handle->pCus_sensor_SetAEGain_cal   = pCus_SetAEGain_cal;
    ...
    handle->pCus_sensor_GetShutterInfo = H66_GetShutterInfo;
...
SENSOR_DRV_ENTRY_IMPL_END_EX(  H66,
