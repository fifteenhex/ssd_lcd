...
SENSOR_DRV_ENTRY_IMPL_BEGIN_EX(SC2332);
...
static int pCus_poweroff(ms_cus_sensor *handle, u32 idx)
{
    // power/reset low
    ISensorIfAPI *sensor_if = handle->sensor_if_api;
    sc2332_params *params = (sc2332_params *)handle->private_data;
...
static int sc2332_SetPatternMode(ms_cus_sensor *handle,u32 mode)
{
  int i;
  SENSOR_DMSG("\n\n[%s], mode=%d \n", __FUNCTION__, mode);
...
static int pCus_SetAEGain(ms_cus_sensor *handle, u32 gain) {
    ...
    params->tGain_reg[3].data = Fine_again_reg;      // 3e09
    params->tGain_reg[2].data = Ana_gain_reg;        // 3e08
    params->tGain_reg[1].data = Fine_dgain_reg;      // 3e07
    params->tGain_reg[0].data = Dgain_reg & 0x0f;    // 3e06
...
static int sc2332_GetShutterInfo(struct __ms_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
int cus_camsensor_init_handle_linear(ms_cus_sensor* drv_handle) {
   ms_cus_sensor *handle = drv_handle;
    ...
    params = (sc2332_params *)handle->private_data;
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    strcpy(handle->model_id,"sc2332_MIPI");
    ...
    handle->pCus_sensor_SetPatternMode = sc2332_SetPatternMode;
    ///////////////////////////////////////////////////////
    // AE
    ///////////////////////////////////////////////////////
    // unit: micro seconds
    ...
    handle->pCus_sensor_GetShutterInfo = sc2332_GetShutterInfo;
...
SENSOR_DRV_ENTRY_IMPL_END_EX(  SC2332,
