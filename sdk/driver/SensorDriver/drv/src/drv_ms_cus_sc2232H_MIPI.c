...
static int pCus_SetOrien(ms_cus_sensor *handle, CUS_CAMSENSOR_ORIT orit)
{
    ...
    switch(orit)
    {
        ...
        case CUS_ORIT_M1F0:
            ...
            params->tMirror_reg[1].data = 0x05;
            params->cur_orien = CUS_ORIT_M1F0;
            params->reg_mf = true;
            params->reg_dirty = true;
            break;
        case CUS_ORIT_M0F1:
            params->tMirror_reg[0].data = 0xE0;
            params->tMirror_reg[1].data = 0x01;
            ...
            break;
        case CUS_ORIT_M1F1:
            params->tMirror_reg[0].data = 0xE6;
            params->tMirror_reg[1].data = 0x05;
...
static int pCus_SetFPS(ms_cus_sensor *handle, u32 fps)
{
    ...
    if(params->expo.line > 2*(params->expo.vts) -4){
...
static int pCus_SetAEGain(ms_cus_sensor *handle, u32 gain) {
    ...
    if (gain < 2*1024) {
        params->tNr_reg[0].data = 0x0f;
        params->tNr_reg[1].data = 0x08;
    } else if (gain < 4*1024) {
        params->tNr_reg[0].data = 0x20;
        params->tNr_reg[1].data = 0x08;
    } else if (gain < 8*1024) {
        params->tNr_reg[0].data = 0x28;
        params->tNr_reg[1].data = 0x08;
    }else if (gain < 15872) {
...
#if ENABLE_MANUAL_DPC
    if (gain <= 15872) {
        params->tDPC_reg[0].data = 0x60;
        params->tDPC_reg[1].data = 0x30;
    } else {
        params->tDPC_reg[0].data = 0x01;
        params->tDPC_reg[1].data = 0x02;
    }
#endif
    ...
    params->tGain_reg[2].data = Cgain_reg;
