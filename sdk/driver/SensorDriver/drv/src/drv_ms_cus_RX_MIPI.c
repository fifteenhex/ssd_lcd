...
SENSOR_DRV_ENTRY_IMPL_BEGIN_EX(RX_MIPI);
...
int rx_cus_camsensor_release_handle(ms_cus_sensor *handle);
...
static int rx_SetPatternMode(ms_cus_sensor *handle,u32 mode)
{
#if 0
	int i;
    	SENSOR_DMSG("[%s]\n", __FUNCTION__);
...
#if 0
	char index=0;
	rx_params *params = (rx_params *)handle->private_data;
...
static int rx_GetShutterInfo(struct __ms_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
	SENSOR_DMSG("[%s]\n", __FUNCTION__);
...
#endif
int rx_cus_camsensor_init_handle_ch0(ms_cus_sensor* handle)
{
    rx_params *params;
    if (!handle)
    {
    ...
    params = (rx_params *)handle->private_data;

    ////////////////////////////////////
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id,"rx_MIPI_CH0");
    ...
    handle->video_res_supported.ulcur_res = 1; //default resolution index is 0.
    ...
    sprintf(handle->video_res_supported.res[1].strResDesc, "1920x1080");

    handle->video_res_supported.num_res = 3;
    handle->video_res_supported.ulcur_res = 2; //default resolution index is 0.
    ...
    sprintf(handle->video_res_supported.res[2].strResDesc, "3840x2160");
    ...
    handle->pCus_sensor_release     = rx_cus_camsensor_release_handle;
    ...
    handle->pCus_sensor_SetPatternMode    = rx_SetPatternMode;
    ///////////////////////////////////////////////////////
    // AE
    ///////////////////////////////////////////////////////
    // unit: micro seconds
    ...
    handle->pCus_sensor_GetShutterInfo   = rx_GetShutterInfo;
...
int rx_cus_camsensor_init_handle_ch1(ms_cus_sensor* handle)
{
    rx_params *params;
    if (!handle)
    {
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id,"rx_MIPI_CH1");
...
int rx_cus_camsensor_init_handle_ch2(ms_cus_sensor* handle)
{
    rx_params *params;
    if (!handle)
    {
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id,"rx_MIPI_CH2");
...
SENSOR_DRV_ENTRY_3CHAHD_IMPL_END_EX(rx,
                                    rx_cus_camsensor_init_handle_ch0,
                                    rx_cus_camsensor_init_handle_ch0,
                                    rx_cus_camsensor_init_handle_ch1,
                                    NULL,
                                    rx_params
                                    );
