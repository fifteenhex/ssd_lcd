...
SENSOR_DRV_ENTRY_IMPL_BEGIN(gc2053_1lane);
...
{
 //window_size=1920*1080  mipi@1lane
//mclk=24mhz,mipi_clk=816Mbps
//pixel_line_total=2416,line_frame_total=1125
//row_time=29.6us,frame_rate=30fps
/****system****/
{0xfe,0x80},
{0xfe,0x80},
{0xfe,0x80},
...
static I2C_ARRAY temperature_reg[] = {
    {0x0c, 0x30},
    {0x0d, 0x30},
    {0x0e, 0x30},
    {0x0f, 0x30},
...
#endif
#undef SENSOR_NAME
#define SENSOR_NAME gc2053_1lane
...
SENSOR_DRV_ENTRY_IMPL_END(  gc2053_1lane,
