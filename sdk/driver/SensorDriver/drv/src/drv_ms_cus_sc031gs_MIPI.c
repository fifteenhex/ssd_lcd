...
// fix me here for mstar
// #define Preview_WIDTH       2302                   //resolution Width when preview from mstar zhong

#define Preview_WIDTH       640                   //resolution Width when preview
#define Preview_HEIGHT      480                  //resolution Height when preview
#define Preview_MAX_FPS     180  //25                     //fastest preview FPS
...
const I2C_ARRAY Sensor_init_table_30W30fps[] =
{
	{0x0103,0x01},
	{0x0100,0x00},
	{0x36e9,0x80},
...
static int pCus_init_linear_30W30fps(ms_cus_sensor *handle)
{
    ...
    {
        if(Sensor_init_table_30W30fps[i].reg==0x0100 && 0x01 == Sensor_init_table_30W30fps[i].data)
        {
...
int cus_camsensor_init_handle(ms_cus_sensor* drv_handle) {
   ms_cus_sensor *handle = drv_handle;
    ...
    sprintf(handle->video_res_supported.res[0].strResDesc, "640*480@90fps");
