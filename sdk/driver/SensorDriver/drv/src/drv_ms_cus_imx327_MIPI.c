...
static int pCus_init_mipi4lane_linear_60fps(ms_cus_sensor *handle)
{
    imx327_params *params = (imx327_params *)handle->private_data;
    int i,cnt=0;
    //u16 sen_data;
...
static int pCus_init_mipi2lane_linear_60fps(ms_cus_sensor *handle)
{
    int i,cnt=0;
    SENSOR_DMSG("\n\n[%s]", __FUNCTION__);
...
int cus_camsensor_init_handle(ms_cus_sensor* drv_handle)
{
    ...
    handle->video_res_supported.res[1].max_fps= 60;
...
static int IMX327_GetShutterInfo_hdr_dol_sef1(struct __ms_cus_sensor* handle,CUS_SHUTTER_INFO *info)
{
...
int cus_camsensor_init_handle_hdr_dol_sef1(ms_cus_sensor* drv_handle)
{
    ...
    sprintf(handle->model_id,"IMX327_MIPI_HDR_SEF");
...
static int imx327_SetPatternMode_isp_calibration( ms_cus_sensor *handle, u32 mode )
{
    return SUCCESS;
}
#if 0
...
static int IMX327_GetShutterInfo_isp_calibration( struct __ms_cus_sensor* handle, CUS_SHUTTER_INFO *info )
{
...
static int cus_camsensor_init_handle_hdr_dol_lef(ms_cus_sensor* drv_handle)
{
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    sprintf(handle->model_id,"IMX327_MIPI_HDR_LEF");
