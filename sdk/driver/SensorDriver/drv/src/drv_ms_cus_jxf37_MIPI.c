...
static I2C_ARRAY Sensor_init_table[] =
{
    ...
    {0x78,0x9E},
#endif    
    {0x02,0x03}, //long expo[15:8] texp=expo[15:0]*Tline
    {0x01,0xf4}, //long expo[7:0]
...
static I2C_ARRAY Sensor_init_table_hdr[] =
{
	...
	{0x57,0x60},
	{0x9D,0x00},
	{0x02,0x04}, //long expo[15:8] texp=expo[15:0]*Tline
    {0x01,0xbf}, //long expo[7:0]
	{0x20,0x40},
	{0x21,0x06},
	{0x22,0x8C},
	{0x23,0x0A},
...
static int cus_camsensor_init_handle(ms_cus_sensor* drv_handle) {
   ms_cus_sensor *handle = drv_handle;
    ...
    //    sensor model ID                           //
    ////////////////////////////////////
    strcpy(handle->model_id,"JXF37_MIPI");
