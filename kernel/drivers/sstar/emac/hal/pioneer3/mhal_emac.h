...
//-------------------------------------------------------------------------------------------------
#define SCATTER_DMA             1
#define SCATTER_DMA_BYPASS      0
#define SCATTER_DMA_V3          0
#define TX_DELAY_INT            1
...
#define REG_ETH_EMAC1_h31               0x00000062           //sactter table address low
#define REG_ETH_EMAC1_h32               0x00000064           //sactter table address high
    #define SG_TBL_ADDR_POS                     0
    #define SG_TBL_ADDR_MASK                    (0xFFFF << SG_TBL_ADDR_POS)
#define REG_ETH_EMAC1_h33               0x00000066           //scatter length/flag/load
    #define SG_TBL_LEN_POS                      0
    #define SG_TBL_LEN_MASK                     (0x7FF << SG_TBL_LEN_POS)
    #define SG_TBL_FLAG                         (0x1 << 11)
    #define SG_TBL_LOAD                         (0x1 << 12)
    #define SW_CLEAR_POS                        13
    #define SW_CLEAR_MASK                       (0x7 << SW_CLEAR_POS)
#define REG_ETH_EMAC1_h39               0x00000072
    #define BYPASS_EN                           (0x1 << 0)
    #define PTR_LOAD                            (0x1 << 1)
    #define LAST_CTRL                           (0x1 << 2)
    #define SURPLUS_EN                          (0x1 << 3)
    #define RX_DES_MIU_READ_BYPASS              (0x1 << 4)
    #define SW_RST                              (0x1 << 5)
#define REG_ETH_EMAC1_h3a               0x00000074
#define REG_ETH_EMAC1_h3b               0x00000076
#define REG_ETH_EMAC1_h3c               0x00000078
#define REG_ETH_EMAC1_h3d               0x0000007A
    #define ERROR_LENGTH_FLAG                   (0x1 << 2)
    #define TABLE_EMPTY                         (0x1 << 6)
    #define TABLE_FULL                          (0x1 << 7)
#define REG_ETH_EMAC1_h3e               0x0000007C
#define REG_ETH_EMAC1_h3f               0x0000007E
#define REG_ETH_EMAC1_h40               0x00000080         //miu_addr_max low
#define REG_ETH_EMAC1_h41               0x00000082         //miu_addr_max high
#define REG_ETH_EMAC1_h42               0x00000084         //miu_addr_min low
#define REG_ETH_EMAC1_h43               0x00000086         //miu_addr_min high
    #define MIU_ADDR_POS                        0
    #define MIU_ADDR_MASK                       (0xFFFF << MIU_ADDR_POS)
#define REG_ETH_EMAC1_h4D               0x0000009A         //reg_pause

#define REG_ETH_EMAC1_h70               0x000000E0         //scatter dma table base address
#define REG_ETH_EMAC1_h71               0x000000E2         //scatter dma table base address
#define REG_ETH_EMAC1_h72               0x000000E4         //packeted base address
#define REG_ETH_EMAC1_h73               0x000000E6         //packeted base address
#define REG_ETH_EMAC1_h74               0x000000E8
    #define SCATTER_DMA_VER                     (0x1 << 0) //scatter dma version 3 enable
    #define EMAC_TO_IMI_PRIORITY                (0x1 << 1)
...
void MHal_EMAC_SG_BYPASS(void*, int bEnable);
u32 MHal_EMAC_RX_MIU_ADDR(void*, u32 addr, u32 len);
int MHal_EMAC_SG_WRITE(void*, u32 addr, u16 len, u16 frags, u16 idx);
void MHal_EMAC_SG_V3(void* hal, int bEnable);
void MHal_EMAC_SG_V3_TABLE_ADDR(void* hal, u32 addr);
void MHal_EMAC_SG_V3_PACKET_ADDR(void* hal, u32 addr);
void MHal_EMAC_SG_V3_FRAG_FILL(u32 addr, u16 len, u16 index, int end);

u32 MHal_EMAC_PACKET_CNT(void*);
