...
#define MSB250X_HIGH_BANDWIDTH_EP(_dev, _ep)        _ep = ((_dev)->ep[1].ep.desc)? NULL : &((_dev)->ep[1].ep)
#define MSB250X_INTR_EP(_dev, _ep)                  _ep = ((_dev)->ep[3].ep.desc)? NULL : &((_dev)->ep[3].ep)
