...
static CamOsTsem_t g_stSemaphore[HAL_HWI2C_PORTS];
////////////////////////////////////////////////////////////////////////////////
// Extern Function
////////////////////////////////////////////////////////////////////////////////
...
u8 HAL_HWI2C_ReadChipPmByte(u32 u32RegAddr)
{
    u16 u16value;

    //HWI2C_HAL_FUNC();
    //HWI2C_HAL_INFO("HWI2C IOMap chipbase:%8x u32RegAddr:%8x u32RegAddr:%8x\n", 0xFD007E00, u32RegAddr,(0xFD007E00+((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF)/ 2) << 2)));

    u16value = (*(volatile u32*)(0xFD007E00+((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF)/ 2) << 2)));
    HWI2C_HAL_INFO("u16value===:%4x\n", u16value);
    return ((u32RegAddr & 0xFF) % 2)? HIBYTE(u16value) : LOWBYTE(u16value);
}
...
bool HAL_HWI2C_WriteChipPmByte(u32 u32RegAddr, u8 u8Val)
{
    u16 u16value;


    //HWI2C_HAL_FUNC();
    //("HWI2C IOMap chipbase:%8x u32RegAddr:%8x\n", 0xFD007E00, u32RegAddr);

    if((u32RegAddr & 0xFF) % 2)
    {
        u16value = (((u16)u8Val) << 8)|((*(volatile u32*)(0xFD007E00+((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF)/ 2) << 2))) & 0xFF);
    }
    else
    {
        u16value = ((u16)u8Val)|((*(volatile u32*)(0xFD007E00+((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF)/ 2) << 2))) & 0xFF00);
    }

    (*(volatile u32*)(0xFD007E00+((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF)/ 2) << 2))) = u16value;
    return TRUE;
}
...
bool HAL_HWI2C_WriteChipPmByteMask(u32 u32RegAddr, u8 u8Val, u8 u8Mask)
{

    //HWI2C_HAL_FUNC();
    //HWI2C_HAL_INFO("HWI2C IOMap chipbase:%8x u32RegAddr:%8x\n", _gMChipIO_MapBase, u32RegAddr);

    u8Val = (HAL_HWI2C_ReadChipPmByte(u32RegAddr) & ~u8Mask) | (u8Val & u8Mask);
    HAL_HWI2C_WriteChipPmByte(u32RegAddr, u8Val);
    return TRUE;
}
...
u8 HAL_HWI2C_ReadClkByte(u32 u32RegAddr)
{
    u16 u16value;

    HWI2C_HAL_FUNC();
    HWI2C_HAL_INFO("HWI2C IOMap clkbase:%8x u32RegAddr:%8x u32RegAddr:%8x\n", _gMClkIO_MapBase, u32RegAddr, (_gMClkIO_MapBase + ((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF) / 2) << 2)));

    u16value = (*(volatile u32*)(_gMClkIO_MapBase + ((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF) / 2) << 2)));
    HWI2C_HAL_INFO("u16value===:%4x\n", u16value);
    return ((u32RegAddr & 0xFF) % 2) ? HIBYTE(u16value) : LOWBYTE(u16value);
}

bool HAL_HWI2C_WriteClkByte(u32 u32RegAddr, u8 u8Val)
{
    u16 u16value;
    ...
    if((u32RegAddr & 0xFF) % 2)
    {
        u16value = (((u16)u8Val) << 8) | ((*(volatile u32*)(_gMClkIO_MapBase + ((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF) / 2) << 2))) & 0xFF);
    }
    else
    {
        u16value = ((u16)u8Val) | ((*(volatile u32*)(_gMClkIO_MapBase + ((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF) / 2) << 2))) & 0xFF00);
    }

    (*(volatile u32*)(_gMClkIO_MapBase + ((u32RegAddr & 0xFFFFFF00) << 1) + (((u32RegAddr & 0xFF) / 2) << 2))) = u16value;
    return TRUE;
}
...
bool HAL_HWI2C_WriteClk2ByteMask(u32 u32RegAddr, u16 u16Val, u16 u16Mask)
{
    HWI2C_HAL_FUNC();
    HWI2C_HAL_INFO("HWI2C IOMap clkbase:%8x u32RegAddr:%8x\n", _gMClkIO_MapBase, u32RegAddr);
...
bool HAL_HWI2C_WriteClkByteMask(u32 u32RegAddr, u8 u8Val, u8 u8Mask)
{

    HWI2C_HAL_FUNC();
    HWI2C_HAL_INFO("HWI2C IOMap clkbase:%8x u32RegAddr:%8x\n", _gMClkIO_MapBase, u32RegAddr);

    u8Val = (HAL_HWI2C_ReadClkByte(u32RegAddr) & ~u8Mask) | (u8Val & u8Mask);
    HAL_HWI2C_WriteClkByte(u32RegAddr, u8Val);
    return TRUE;
}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_Core2DMA_SetINT
/// @brief \b Function  \b Description: Enable Interrupt (set int en core to DMA inside IP)
/// @param <IN>         \b bEnable : TRUE: Enable, FALSE: Disable
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Ok, FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
static bool HAL_HWI2C_DMA_Core2DMA_SetINT(u16 u16PortOffset, bool bEnable)
{
    HWI2C_HAL_FUNC();
    return HAL_HWI2C_WriteRegBit(REG_HWI2C_RESERVE0+u16PortOffset, _INT_CFG_CORE2DMA, bEnable);
}
...
static bool HAL_HWI2C_DMA_SetMiuAddr(u16 u16PortOffset, u32 u32MiuAddr)
{
    ...
    HAL_HWI2C_WriteRegBit(REG_HWI2C_DMA_RESERVED0+u16PortOffset, __BIT7|__BIT5|__BIT4, TRUE);

    return HAL_HWI2C_Write4Byte(REG_HWI2C_DMA_MIU_ADR+u16PortOffset, (u32)CamOsMemPhysToMiu(u32MiuAddr));
}
...
static bool HAL_HWI2C_DMA_SetMiuData(u16 u16PortOffset, u32 u32Length, u8* pu8SrcData)
{
    ...
    CamOsMemFlush((void*)pu8SrcData, u32Length);
    memcpy(pMiuData,pu8SrcData,u32Length);
    CamOsMemFlush((void*)pMiuData,u32Length);
    while(pMiuData[u32Length-1] != pu8SrcData[u32Length-1]);
...
static bool HAL_HWI2C_DMA_GetMiuData(u16 u16PortOffset, u32 u32Length, u8* pu8DstData)
{
    ...
    CamOsMemFlush((void*)pu8DstData, u32Length);
    return TRUE;
}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_SetGroupLen
/// @brief \b Function  \b Description: Set HWI2C DMA group length (nwrite N)
/// @param <IN>         \b u32DataLen : group length
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static bool HAL_HWI2C_DMA_SetGroupLen(u16 u16PortOffset, u32 u32GroupLen)
{
    u32 u32GroupLenSet;

    HWI2C_HAL_FUNC();
    u32GroupLenSet = u32GroupLen;
    return HAL_HWI2C_Write4Byte(REG_HWI2C_DMA_GROUP_LEN+u16PortOffset, u32GroupLenSet);
}
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_EnDMA
/// @brief \b Function  \b Description: Enable DMA
...
/// @param <RET>        \b TRUE: Ok, FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
static bool HAL_HWI2C_EnWnmode(u16 u16PortOffset, bool bEnable)
{
    HWI2C_HAL_FUNC();
    return HAL_HWI2C_WriteRegBit(REG_HWI2C_DMA_WNMODE_EN+u16PortOffset, _DMA_CTL_WNMODE_EN, bEnable);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_SetWaitCnt
/// @brief \b Function  \b Description: Set wait cnt
/// @param <IN>         \b bEnable : TRUE: Enable, FALSE: Disable
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Ok, FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
static bool HAL_HWI2C_DMA_SetWaitCnt(u16 u16PortOffset, u32 u32WaitCnt)
{
    HWI2C_HAL_FUNC();
    return HAL_HWI2C_Write4Byte(REG_HWI2C_DMA_WN_WAITCNT+u16PortOffset, u32WaitCnt);
}
...
bool HAL_HWI2C_GetPortIdxByPort(HAL_HWI2C_PORT ePort, u8* pu8Port)
{
    ...
    if((ePort>=E_HAL_HWI2C_PORT0_0)&&(ePort<=E_HAL_HWI2C_PORT0_14))
    {
        *pu8Port = HAL_HWI2C_PORT0;
    }
    else if((ePort>=E_HAL_HWI2C_PORT1_0)&&(ePort<=E_HAL_HWI2C_PORT1_11))
    {
        *pu8Port = HAL_HWI2C_PORT1;
    }
...
bool HAL_HWI2C_SelectPort(HAL_HWI2C_PORT ePort)
{
    ...
    case E_HAL_HWI2C_PORT0_5: u8Val = CHIP_MIIC0_PAD_5; break;
    case E_HAL_HWI2C_PORT0_6: u8Val = CHIP_MIIC0_PAD_6; break;
    case E_HAL_HWI2C_PORT0_7: u8Val = CHIP_MIIC0_PAD_7; break;
    case E_HAL_HWI2C_PORT0_8: u8Val = CHIP_MIIC0_PAD_8; break;
    case E_HAL_HWI2C_PORT0_9: u8Val = CHIP_MIIC0_PAD_9; break;
    case E_HAL_HWI2C_PORT0_10: u8Val = CHIP_MIIC0_PAD_10; break;
    case E_HAL_HWI2C_PORT0_11: u8Val = CHIP_MIIC0_PAD_11; break;
    case E_HAL_HWI2C_PORT0_12: u8Val = CHIP_MIIC0_PAD_12; break;
    case E_HAL_HWI2C_PORT0_13: u8Val = CHIP_MIIC0_PAD_13; break;
    case E_HAL_HWI2C_PORT0_14: u8Val = CHIP_MIIC0_PAD_14; break;
    ...
    case E_HAL_HWI2C_PORT1_6: u8Val = CHIP_MIIC1_PAD_6; break;
    case E_HAL_HWI2C_PORT1_7: u8Val = CHIP_MIIC1_PAD_7; break;
    case E_HAL_HWI2C_PORT1_8: u8Val = CHIP_MIIC1_PAD_8; break;
    case E_HAL_HWI2C_PORT1_9: u8Val = CHIP_MIIC1_PAD_9; break;
    case E_HAL_HWI2C_PORT1_10: u8Val = CHIP_MIIC1_PAD_10; break;
    case E_HAL_HWI2C_PORT1_11: u8Val = CHIP_MIIC1_PAD_11; break;
    // case E_HAL_HWI2C_PORT1_4: u8Val = CHIP_MIIC1_PAD_4; break;
	...
	case E_HAL_HWI2C_PORT2_4:
		u8Val = CHIP_MIIC2_PAD_4;
		HAL_HWI2C_WriteChipPmByteMask(CHIP_REG_PM_PAD_EXT_MODE1, CHIP_PAD_PM_I2CM_SCL,  CHIP_PAD_PM_I2CM_SCL);
		HAL_HWI2C_WriteChipPmByteMask(CHIP_REG_PM_PAD_EXT_MODE1, CHIP_PAD_PM_I2CM_SDA,  CHIP_PAD_PM_I2CM_SDA);
		break;
	case E_HAL_HWI2C_PORT2_5: u8Val = CHIP_MIIC2_PAD_5; break;
...
bool HAL_HWI2C_DMA_Enable(u16 u16PortOffset, bool bEnable)
{
    ...
    HWI2C_HAL_FUNC();
    bRet &= HAL_HWI2C_DMA_Core2DMA_SetINT(u16PortOffset,bEnable); //DMA enable, always enable
    bRet &= HAL_HWI2C_DMA_SetINT(u16PortOffset,FALSE); //force int disable, prevent pulling time out
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_TsemInit
...
{
	CamOsTsemInit(&g_stSemaphore[u8Port], 0);
}
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_TsemDeinit
/// @brief \b Function  \b Description: deinit Tcond
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b None :
////////////////////////////////////////////////////////////////////////////////
...
{
	CamOsTsemDeinit(&g_stSemaphore[u8Port]);
}
////////////////////////////////////////////////////////////////////////////////
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
bool HAL_HWI2C_DMA_WriteBytes(u16 u16PortOffset, u16 u16SlaveCfg, u32 uAddrCnt, u8 *pRegAddr, u32 uSize, u8 *pData, u8 u8Sendstop)
{
    ...
    HAL_HWI2C_DMA_SetTxfrStop(u16PortOffset, u8Sendstop);
    //set slave address
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_WN_I2c0_Isr
/// @brief \b Function  \b Description: Isr of DMA tx done
/// @param <IN>         \b IntNum : Int number, void * dev_id
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static void HAL_HWI2C_DMA_WN_I2c0_Isr(int IntNum, void* dev_id)
{
	u16 u16PortOffset;

	HAL_HWI2C_SetPortRegOffset(0, &u16PortOffset);
	HAL_HWI2C_DMA_TxfrDone(u16PortOffset);
	CamOsTsemUp(&g_stSemaphore[0]);
};
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_WN_I2c1_Isr
/// @brief \b Function  \b Description: Isr of DMA tx done
/// @param <IN>         \b IntNum : Int number, void * dev_id
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static void HAL_HWI2C_DMA_WN_I2c1_Isr(int IntNum, void* dev_id)
{
	u16 u16PortOffset;

	HAL_HWI2C_SetPortRegOffset(1, &u16PortOffset);
	HAL_HWI2C_DMA_TxfrDone(u16PortOffset);
	CamOsTsemUp(&g_stSemaphore[1]);
};
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_WN_I2c2_Isr
/// @brief \b Function  \b Description: Isr of DMA tx done
/// @param <IN>         \b IntNum : Int number, void * dev_id
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static void HAL_HWI2C_DMA_WN_I2c2_Isr(int IntNum, void* dev_id)
{
	u16 u16PortOffset;

	HAL_HWI2C_SetPortRegOffset(2, &u16PortOffset);
	HAL_HWI2C_DMA_TxfrDone(u16PortOffset);
	CamOsTsemUp(&g_stSemaphore[2]);
};
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_WN_SetMiuData
/// @brief \b Function  \b Description: Set MIIC WN DMA Miu data buf
/// @param <IN>         \b u16PortOffset: port offset, pmsg: i2c msg, u32cnt: msg cnt
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static bool HAL_HWI2C_DMA_WN_SetMiuData(u16 u16PortOffset, tI2cMsg* pmsg, u32 u32cnt)
{
    //u32 u32PhyAddr = 0;
    u8 *pMiuData = 0;
    u8 u8Port;
    u32 i;
    tI2cMsg* pCurmsg = pmsg;
    ...
    {
        pCurmsg = pmsg + i;
        memcpy(pMiuData + (i * pCurmsg->len), pCurmsg->buf, pCurmsg->len);
    }
    HAL_HWI2C_DMA_SetDataLen(u16PortOffset, (pmsg->len *u32cnt));

    return TRUE;
}
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_WN_WaitDone
/// @brief \b Function  \b Description: trigger and wait DMA wn mode tx done
/// @param <IN>         \b u16PortOffset: port offset, u8ReadWrite : read or write
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
static bool HAL_HWI2C_DMA_WN_WaitDone(u16 u16PortOffset, u8 u8ReadWrite)
{
    u8 u8Port;
	u32 u32Txfrcnt;
    ...
    HAL_HWI2C_DMA_SetRdWrt(u16PortOffset,u8ReadWrite);
    //set int en
    HAL_HWI2C_DMA_SetINT(u16PortOffset, TRUE);
    //issue write trigger
    //HWI2C_HAL_ERR("[DMA]HAL_HWI2C_DMA_Trigger\n");
    HAL_HWI2C_DMA_Trigger(u16PortOffset);
	//CamOsTcondTimedWait
	if (CAM_OS_TIMEOUT == CamOsTsemTimedDown(&g_stSemaphore[u8Port], 1000)){
		HWI2C_HAL_ERR("[DMA]: WN Wait ISR time out!\n");
		return FALSE;
	}
    //disable int
    HAL_HWI2C_DMA_SetINT(u16PortOffset, FALSE);
    //HWI2C_HAL_ERR("[DMA]: WN Transfer DONE!\n");
    if(HAL_HWI2C_Get_SendAck(u16PortOffset)){
        return TRUE;
	} else {
		u32Txfrcnt = HAL_HWI2C_DMA_GetTxfrCnt(u16PortOffset);
		HWI2C_HAL_ERR("[DMA]: WN Transfer NACK!\n");
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_WN_WriteBytes
/// @brief \b Function  \b Description: DMA WN mode write bytes
/// @param <IN>         \b u16PortOffset: port offset, u16SlaveCfg: slave addr, pmsg: i2c_msg, u32cnt: msg cnt
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
bool HAL_HWI2C_DMA_WN_WriteBytes(u16 u16PortOffset, u16 u16SlaveCfg, tI2cMsg* pmsg, u32 u32cnt)
{
	u8 u8SlaveAddr = LOW_BYTE(u16SlaveCfg)>>1;
	...
	if(pmsg == NULL){
		HWI2C_HAL_ERR("[DMA_NW]: Null pointer pmsg!\n");
        return FALSE;
	}
	//set transfer with stop
    HAL_HWI2C_DMA_SetTxfrStop(u16PortOffset,TRUE);
    //set slave address
    HAL_HWI2C_DMA_SetSlaveAddr(u16PortOffset,u8SlaveAddr);
	//set multi data to dram
	if(HAL_HWI2C_DMA_WN_SetMiuData(u16PortOffset, pmsg, u32cnt)==FALSE)
	{
	    HWI2C_HAL_ERR("[DMA_NW]: Set MIU data error!\n");
        return FALSE;
	}
	//set n number
	HAL_HWI2C_DMA_SetGroupLen(u16PortOffset, pmsg->len);
	//enable nwrite mode
	HAL_HWI2C_EnWnmode(u16PortOffset, TRUE);
	//Set wait count
	HAL_HWI2C_DMA_SetWaitCnt(u16PortOffset, 0x1FFF);
	//trigger and wait ISR
	if(HAL_HWI2C_DMA_WN_WaitDone(u16PortOffset,HWI2C_DMA_WRITE)==FALSE){
		return FALSE;
	}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_DMA_WN_WriteSeq
/// @brief \b Function  \b Description: DMA WN mode write seqs
/// @param <IN>         \b u16PortOffset: port offset, u16SlaveCfg: slave addr, pmsg: i2c_msg, num: total msg num
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
bool HAL_HWI2C_DMA_WN_WriteSeq(u16 u16PortOffset, u16 u16SlaveCfg, void* pmsg, u32 num)
{
	u16 u16nwritecnt[HAL_HWI2C_NWRITE_MAXNUM] = {0xFFFF};
	u16 i = 1;
	u16 u16index = 0;
	u16 len;
	tI2cMsg* pi2cmsg = (tI2cMsg*)pmsg;
	...
	//first
	len = pi2cmsg->len;
	u16nwritecnt[u16index] = 1;

	while(i < num)
	{
		pi2cmsg++;
		if(pi2cmsg->len == len){
			u16nwritecnt[u16index]++;
		}
		else{
			u16index++;
			u16nwritecnt[u16index] = 1;
	...
	//point to start addr
	pi2cmsg = (tI2cMsg*)pmsg;
	//1.array 2.cnt = u16index + 1
	for( i = 0; i <= u16index; i++)
	{
		if(u16nwritecnt[i] == 0xFFFF){
			break;
		}

		if(!HAL_HWI2C_DMA_WN_WriteBytes(u16PortOffset, u16SlaveCfg, pi2cmsg, u16nwritecnt[i])){
			return FALSE;
		}
		pi2cmsg+=u16nwritecnt[i];
	}

	return TRUE;
}
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_CheckAbility
/// @brief \b Function  \b Description: check function ability by etype
/// @param <IN>         \b etype: feature type, fp :function pointer of feature
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
bool HAL_HWI2C_CheckAbility(HAL_HWI2C_HW_FEATURE etype,mhal_i2c_feature_fp *fp)
{
	//tmp disable wn dma write
	#if 0
	switch (etype)
	{
		case E_HAL_HWI2C_FEATURE_NWRITE:
			*fp = (mhal_i2c_feature_fp)HAL_HWI2C_DMA_WN_WriteSeq; //TODO
			return TRUE;
		break;
		default:
			return FALSE;
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_IrqRequest
/// @brief \b Function  \b Description: request IRQ
/// @param <IN>         \b u32irq: irq num, u32group: port,pdev: dev
/// @param <OUT>        \b None :
/// @param <RET>        \b None :
////////////////////////////////////////////////////////////////////////////////
void HAL_HWI2C_IrqRequest(u32 u32irq, u32 u32group, void *pdev)
{
	...
	{
		case 0:
			if (0 == CamOsIrqRequest(u32irq, (CamOsIrqHandler)HAL_HWI2C_DMA_WN_I2c0_Isr, "I2C0", pdev)){
				HWI2C_HAL_ERR("[I2C] i2c0 irq interrupt registered #%d\n", u32irq);}
			else{
				HWI2C_HAL_ERR("[I2C] failed to request i2c0 irq #%d\n", u32irq);}
		break;
		case 1:
			if (0 == CamOsIrqRequest(u32irq, (CamOsIrqHandler)HAL_HWI2C_DMA_WN_I2c1_Isr, "I2C1", pdev)){
				HWI2C_HAL_ERR("[I2C] i2c1 irq interrupt registered #%d\n", u32irq);}
			else{
				HWI2C_HAL_ERR("[I2C] failed to request i2c1 irq #%d\n", u32irq);}
		break;
		case 2:
			if (0 == CamOsIrqRequest(u32irq, (CamOsIrqHandler)HAL_HWI2C_DMA_WN_I2c2_Isr, "I2C2", pdev)){
				HWI2C_HAL_ERR("[I2C] i2c2 irq interrupt registered #%d\n", u32irq);}
			else{
				HWI2C_HAL_ERR("[I2C] failed to request i2c2 irq #%d\n", u32irq);}
		break;
		default:
		break;
	}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C_IrqFree
/// @brief \b Function  \b Description: free IRQ
/// @param <IN>         \b u32irq: irq num
/// @param <OUT>        \b None :
/// @param <RET>        \b None :
////////////////////////////////////////////////////////////////////////////////
void HAL_HWI2C_IrqFree(u32 u32irq)
{
	CamOsIrqFree(u32irq, NULL);
}
/*
bool HAL_HWI2C_DMA_WaitDone(u16 u16PortOffset, u8 u8ReadWrite)
{
	//1.DMA rsest
	//2.DMA MIU reset
	//3.clear tx done
	//4.set write mode
	//5.trigger DMA
	//6.wait ISR ,using CamOsTcondTimedWait
	//7.if wait time out, check NACK reg
	//8.tx done, return
}

bool HAL_HWI2C_DMA_NwriteMode_WriteBytes(pmsg, num)
{
	// 1.Check pmsg/num and split it to several continous parts
	// |3bytes|3bytes|3bytes|4btyes|3bytes|
	// ==> |3bytes|3bytes|3bytes| + |4btyes| + 3bytes|
	// send 3 times nwrite mode by for loop
	// 2.Set nwrite para and trigger
	// (1.)SetTxfrStop
	// (2.)Set Slave Addr
	// (3.)Set miu addr
	// (4.)Set data length and N number
	// (5.)Enable nwrite mode
	// (6.)Set wait count
	// (7.)Trigger tx and DMA wait done by ISR
}
*/
