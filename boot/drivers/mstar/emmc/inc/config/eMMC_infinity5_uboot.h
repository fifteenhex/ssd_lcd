/*
* eMMC_infinity5_uboot.h- Sigmastar
*
...
#ifndef __eMMC_INFINITY5_UBOOT__
#define __eMMC_INFINITY5_UBOOT__
...
#define EMMC_SEL_INTERFACE      0 //[0:1:2]/[FCIE:SDIO:SD]
#if (EMMC_SEL_INTERFACE == 0)
#define REG_BANK_FCIE0          0x20100U //1402
#define REG_BANK_FCIE1          0x20180U //1403
#define REG_BANK_FCIE2          0x20200U //1404
#elif (EMMC_SEL_INTERFACE == 1)
#define REG_BANK_FCIE0          0x20800U //1410
#define REG_BANK_FCIE1          0x20880U //1411
#define REG_BANK_FCIE2          0x20900U //1412
#else
#define REG_BANK_FCIE0          0x20980U //1413
#define REG_BANK_FCIE1          0x20A00U //1414
#define REG_BANK_FCIE2          0x20A80U //1415
#endif
...
#elif (EMMC_SEL_INTERFACE == 1)
#define BIT_CLKGEN_FCIE_MASK            (BIT4|BIT3|BIT2) //(BIT4|BIT3|BIT2)
#else
#define BIT_CLKGEN_FCIE_MASK            (BIT4|BIT3|BIT2) //(BIT4|BIT3|BIT2)
#endif
#define BIT_FCIE_CLK_SRC_SEL            BIT6 // 0: clk_xtal 12M, 1: clk_nfie_p1

#define REG_BANK_SC_GP_CTRL				(0x1133 - 0x1000) * 0x80 //bank:x1133->reg_block
...
#define BIT_SDIO_MODE_MASK                  (BIT10|BIT9|BIT8)
#define BIT_SDIO_MODE_1                     BIT9
...
#elif (EMMC_SEL_INTERFACE == 1)
#define BIT_SDIO_CLK_48M                0x0
#define BIT_SDIO_CLK_43_2M              0x1
#define BIT_SDIO_CLK_40M                0x2
#define BIT_SDIO_CLK_36M                0x3
#define BIT_SDIO_CLK_32M                0x4
#define BIT_SDIO_CLK_20M                0x5
#define BIT_CLK_XTAL_12M                0x6
#define BIT_SDIO_CLK_300K               0x7

#define BIT_FCIE_CLK_20M                BIT_SDIO_CLK_20M
#define BIT_FCIE_CLK_32M                BIT_SDIO_CLK_32M
#define BIT_FCIE_CLK_36M                BIT_SDIO_CLK_36M
#define BIT_FCIE_CLK_40M                BIT_SDIO_CLK_40M
#define BIT_FCIE_CLK_43_2M              BIT_SDIO_CLK_43_2M
#define BIT_FCIE_CLK_300K               BIT_SDIO_CLK_300K
#define BIT_FCIE_CLK_48M                BIT_SDIO_CLK_48M
#else
...
#define ENABLE_eMMC_RIU_MODE				1 // for debug cache issue
...
#define FCIE_HIGH_SPEED_CLK             BIT_FCIE_CLK_43_2M
...
#endif /* __eMMC_INFINITY5_UBOOT__ */
