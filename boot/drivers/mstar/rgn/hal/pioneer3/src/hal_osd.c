...
void _HalOsdGetBindReg(u32 u32GopOsdFlag,u16 *u16GopMap)
{
    ...
    if((u32GopOsdFlag & E_HAL_RGN_OSD_FLAG_PORT1) ||
       (u32GopOsdFlag & E_HAL_RGN_OSD_FLAG_DIP) )
    {
        *u16GopMap = REG_OSD_TO_GOP_MAP_PORT1;
    }
    else
    {
        *u16GopMap = REG_OSD_TO_GOP_MAP_PORT0;
    }
...
bool HalOsdSetBindGop(u32 u32GopOsdFlag)
{
    ...
    if((u32GopOsdFlag & E_HAL_RGN_OSD_FLAG_PORT1) ||
       (u32GopOsdFlag & E_HAL_RGN_OSD_FLAG_PORT0) ||
       (u32GopOsdFlag & E_HAL_RGN_OSD_FLAG_DIP))
    {
...
void HalOsdSetOsdEnable(HalOsdIdType_e eOsdId, bool bEn)
{
    ...
    if( eOsdId == E_HAL_OSD_PORT0 || eOsdId == E_HAL_OSD_PORT1 || eOsdId == E_HAL_OSD_DIP)
    {
