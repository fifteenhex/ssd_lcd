/*
* mstar_i2c_reg_pioneer3.h- Sigmastar
*
...
#ifndef __HAL_BUS_I2C_REG_P3_H__
#define __HAL_BUS_I2C_REG_P3_H__
...
#define CHIP_REG_HWI2C_MIIC0            (CHIP_REG_BASE+ (0x6f*2))
    ...
    #define CHIP_MIIC0_PAD_6            (__BIT1|__BIT2)
    #define CHIP_MIIC0_PAD_7            (__BIT0|__BIT1|__BIT2)
    #define CHIP_MIIC0_PAD_8            (__BIT3)
    #define CHIP_MIIC0_PAD_9            (__BIT0|__BIT3)
    #define CHIP_MIIC0_PAD_10           (__BIT1|__BIT3)
    #define CHIP_MIIC0_PAD_11           (__BIT0|__BIT1|__BIT3)
    #define CHIP_MIIC0_PAD_12           (__BIT2|__BIT3)
    #define CHIP_MIIC0_PAD_13           (__BIT0|__BIT2|__BIT3)
    #define CHIP_MIIC0_PAD_14           (__BIT1|__BIT2|__BIT3)
    #define CHIP_MIIC0_PAD_MSK          (__BIT0|__BIT1|__BIT2|__BIT3)
...
#define CHIP_REG_HWI2C_MIIC1            (CHIP_REG_BASE+ (0x6f*2))
    ...
    #define CHIP_MIIC1_PAD_6            (__BIT5|__BIT6)
    #define CHIP_MIIC1_PAD_7            (__BIT4|__BIT5|__BIT6)
    #define CHIP_MIIC1_PAD_8            (__BIT7)
    #define CHIP_MIIC1_PAD_9            (__BIT4|__BIT7)
    #define CHIP_MIIC1_PAD_10           (__BIT5|__BIT7)
    #define CHIP_MIIC1_PAD_11           (__BIT4|__BIT5|__BIT7)
    #define CHIP_MIIC1_PAD_MSK          (__BIT4|__BIT5|__BIT6|__BIT7)
...
#endif //__HAL_BUS_I2C_REG_P3_H__
