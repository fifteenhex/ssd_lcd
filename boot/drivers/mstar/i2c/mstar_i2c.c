...
#include "mstar_i2c_reg_infinity6e.h"
#elif defined(CONFIG_PIONEER3)
#include "mstar_i2c_reg_pioneer3.h"
#else
#include "mstar_i2c_reg.h"
#endif
...
BOOL HAL_HWI2C_GetPortIdxByPort(HAL_HWI2C_PORT ePort, U8* pu8Port)
{
    ...
    if((ePort >= E_HAL_HWI2C_PORT0_0) && (ePort <= E_HAL_HWI2C_PORT0_11))
    {
        *pu8Port = HAL_HWI2C_PORT0;
    }
    else if((ePort >= E_HAL_HWI2C_PORT1_0) && (ePort <= E_HAL_HWI2C_PORT1_8))
    {
        *pu8Port = HAL_HWI2C_PORT1;
    }
...
BOOL HAL_HWI2C_SelectPort(HAL_HWI2C_PORT ePort)
{
    ...
    else if(ePort == E_HAL_HWI2C_PORT0_4)
    {
        u8Value1 = CHIP_MIIC0_PAD_4;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC0, u8Value1, CHIP_MIIC0_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT0_5)
    {
        u8Value1 = CHIP_MIIC0_PAD_5;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC0, u8Value1, CHIP_MIIC0_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT0_6)
    {
        u8Value1 = CHIP_MIIC0_PAD_6;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC0, u8Value1, CHIP_MIIC0_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT0_7)
    {
        u8Value1 = CHIP_MIIC0_PAD_7;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC0, u8Value1, CHIP_MIIC0_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT0_8)
    {
        u8Value1 = CHIP_MIIC0_PAD_8;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC0, u8Value1, CHIP_MIIC0_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT0_9)
    {
        u8Value1 = CHIP_MIIC0_PAD_9;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC0, u8Value1, CHIP_MIIC0_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT0_10)
    {
        u8Value1 = CHIP_MIIC0_PAD_10;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC0, u8Value1, CHIP_MIIC0_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT0_11)
    {
        u8Value1 = CHIP_MIIC0_PAD_11;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC0, u8Value1, CHIP_MIIC0_PAD_MSK);
    }
    ...
    else if(ePort == E_HAL_HWI2C_PORT1_3)
    {
        u8Value1 = CHIP_MIIC1_PAD_3;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC1, u8Value1, CHIP_MIIC1_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT1_4)
    {
        u8Value1 = CHIP_MIIC1_PAD_4;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC1, u8Value1, CHIP_MIIC1_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT1_5)
    {
        u8Value1 = CHIP_MIIC1_PAD_5;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC1, u8Value1, CHIP_MIIC1_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT1_6)
    {
        u8Value1 = CHIP_MIIC1_PAD_6;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC1, u8Value1, CHIP_MIIC1_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT1_7)
    {
        u8Value1 = CHIP_MIIC1_PAD_7;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC1, u8Value1, CHIP_MIIC1_PAD_MSK);
    }
    else if(ePort == E_HAL_HWI2C_PORT1_8)
    {
        u8Value1 = CHIP_MIIC1_PAD_8;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC1, u8Value1, CHIP_MIIC1_PAD_MSK);
    }
    else
    {
