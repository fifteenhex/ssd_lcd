...
#if 1
static const void *uboot_ld_addr __attribute__((used)) __attribute__((section(".rodata")))= (void *)UBOOT_LOAD_ADDRESS;
static const void *uboot_ep_addr __attribute__((used)) __attribute__((section(".rodata")))= (void *)UBOOT_RUN_ADDRESS;
#else
static const void *uboot_ld_addr __attribute__((used))= UBOOT_LOAD_ADDRESS;
static const void *uboot_ep_addr __attribute__((used))= UBOOT_RUN_ADDRESS;
#endif
