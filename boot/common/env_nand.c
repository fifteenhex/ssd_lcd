...
int nand_saveenv(void)
{
    ...
    {
        flash_get_parts((void*)&nand_info[0], ENV_PART_NAME, (size_t*)&env_offset, (size_t*)&env_part_size);
...
#ifdef CONFIG_MSTAR_ENV_NAND_OFFSET
    size_t env_part_size, env_offset;
    flash_get_parts((void*)&nand_info[0], ENV_PART_NAME, &env_offset, &env_part_size);
...
#ifdef CONFIG_MSTAR_ENV_NAND_REDUND_OFFSET
    flash_get_parts((void*)&nand_info[0], ENV_REDUND_PART_NAME, &env_offset, &env_part_size);
    printf("%s: offset = 0x%x size = 0x%x\r\n", ENV_REDUND_PART_NAME, env_offset, env_part_size);
    CONFIG_ENV_OFFSET_REDUND = (u32)env_offset;
