...
#define CONFIG_PIUTIMER_CLOCK 24000000
#else
...
#define PHYS_SDRAM_1_SIZE   CONFIG_SS_RAM_SIZE  /* 16/64 MB */
...
#define CONFIG_UBOOT_RAM_SIZE   CONFIG_SS_RAM_SIZE // let us to use only 64MB for uboot
...
#define SPI_BASE_ADDR           0x14000000
...
#endif
#define FLASH_ENV_OFFSET        0x20
#ifdef CONFIG_MS_NOR_ENV_BACKUP
#define CONFIG_ENV_OFFSET_REDUND CONFIG_MSTAR_ENV_NOR_REDUND_OFFSET
#define CONFIG_MSTAR_ENV_NOR_REDUND_OFFSET ms_nor_env_redund_offset
#endif
#endif
#endif
...
#if defined(CONFIG_MS_SDMMC) || defined(CONFIG_MS_USB)
...
#define CONFIG_FIRMWAREFS_ON_SDMMC_FLASH    1
#define PARTITION_MISC_INDEX                "MiscPart"
#endif
#endif
...
#endif
#if defined(CONFIG_FIRMWAREFS_ON_MMC)
#define CONFIG_FIRMWAREFS_ON_EMMC_FLASH     1
#endif
#endif
...
#define CONFIG_ENV_RANGE        CONFIG_MSTAR_ENV_NAND_SIZE
#define CONFIG_MSTAR_ENV_NAND_SIZE ms_nand_env_size
/*#define CONFIG_MSTAR_ENV_NAND_OFFSET 0x440000*/
#ifdef CONFIG_MS_NAND_ENV_BACKUP
 ...
 */
#define CONFIG_SYS_I2C_0_PADMUX (0xB)
/*
 * padmux: 1 -> PAD_I2C1_SCL, PAD_I2C1_SDA
 *         2 -> PAD_PWM0, PAD_PWM1
 *         3 -> PAD_SR_IO00, PAD_SR_IO01
 */
#define CONFIG_SYS_I2C_1_PADMUX (0x6)
